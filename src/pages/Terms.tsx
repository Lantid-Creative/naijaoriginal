        ...
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          <div className="prose prose-sm max-w-none font-body text-foreground space-y-6">
            ...
            <section className="bg-card rounded-2xl border border-border p-6 md:p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                We dey ship within Nigeria and internationally. Shipping fee no dey included inside checkout payment.
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-1 mt-2">
                <li>Shipping within Nigeria usually ranges from ₦5,000 to ₦10,000 depending on distance and weight</li>
                <li>We go contact you by phone call or WhatsApp at your preferred day/time to confirm exact location and give final quote</li>
