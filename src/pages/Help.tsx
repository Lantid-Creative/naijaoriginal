...
const faqs = [
  ...
  { icon: Truck, q: "How much is shipping?", a: "Shipping no dey included in checkout payment. Within Nigeria, shipping usually ranges from ₦5,000 to ₦10,000 depending on distance and weight. We go reach out by phone call or WhatsApp at your preferred day/time to confirm exact location and give final quote." },
