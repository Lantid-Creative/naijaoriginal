    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 pb-16">
        <div className="container mx-auto px-6">
          {/* Breadcrumb */}
          <div className="py-6 flex items-center gap-2 font-body text-sm text-muted-foreground">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Images */}
            <div>
              <div className="aspect-square rounded-2xl overflow-hidden border border-border mb-4 bg-muted">
            ...
            <div className="py-4">
              {product.is_limited_edition && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-secondary/10 text-secondary font-accent text-xs font-bold uppercase tracking-wider mb-4">
              ...
              {product.pidgin_tagline && (
                <p className="font-body text-muted-foreground italic mb-4">"{product.pidgin_tagline}"</p>
              )}

              <div className="flex items-center gap-3 mb-6">
                <span className="font-display text-3xl font-bold text-foreground">${product.price.toFixed(2)}</span>
                {product.compare_at_price && (
                  <span className="font-body text-lg text-muted-foreground line-through">${product.compare_at_price.toFixed(2)}</span>
                )}
                {product.compare_at_price && (
                  <span className="px-2 py-0.5 rounded bg-destructive/10 text-destructive font-accent text-xs font-bold">
              ...
              {product.sizes.length > 0 && (
                <div className="mb-6">
                  <label className="font-body text-sm font-semibold text-foreground block mb-2">Size</label>
                  <div className="flex flex-wrap gap-2">
                    {product.sizes.map((size) => (
                      <button
                        key={size}
                        onClick={() => setSelectedSize(size)}
                        className={`px-4 py-2 rounded-lg font-body text-sm border transition-all ${
                          selectedSize === size
              ...
              {product.colors.length > 0 && (
                <div className="mb-6">
                  <label className="font-body text-sm font-semibold text-foreground block mb-2">Color</label>
                  <div className="flex flex-wrap gap-2">
              ...
              {/* Quantity */}
              <div className="mb-8">
                <label className="font-body text-sm font-semibold text-foreground block mb-2">Quantity</label>
              ...
              <Button
                ...
                className="w-full py-6 text-base font-body font-semibold gap-2"
                size="lg"
              >
              ...
              <div className="mt-6 flex items-center gap-2 text-muted-foreground font-body text-sm">
